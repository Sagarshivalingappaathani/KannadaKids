  ...
  useEffect(() => {
    ...
    function draw(e: MouseEvent | TouchEvent) {
      ...
      if (ctx) {
        ...
        ctx.lineTo(x, y);
        ctx.strokeStyle = '#7c3aed'; // kid-purple color
        ctx.lineWidth = 3;
        ctx.lineCap = 'round';
        ctx.stroke();
      }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center py-6">
        <div className="w-full max-w-md mx-auto bg-gray-50 rounded-lg p-6 mb-6 shadow-inner">
          <div className="flex justify-between items-center mb-3">
            <p className="text-gray-600">
              Trace or draw the letter below:
            </p>
            <Button 
              variant="ghost" 
              size="sm" 
              onClick={resetCanvas}
              className="text-kid-purple hover:bg-kid-purple/10"
            >
          ...
          <p className="text-xs text-gray-500 mt-2 text-center">Use your mouse or finger to practice writing</p>
        </div>
      </div>
